...
1. Asset Type - enumerates the kinds of assets a DEMOGRAPHIC might receive.
1. Direction Type - enumerates the direction of a REFERRAL.
1. Interaction Type - enumerates the types of interactions for SESSIONs and CURRICULUM_COMPONENTs.
1. Mode Type - enumerates the ways in which interventions can be delivered in SESSION.
1. Program Type - enumerates the aims of a PROGRAM.
1. Setting Type - enumerates whether intervention is from a clinical or community PROGRAM.
...
The RDM is being updated and upon completion, those changes will be represented in this IG.
